...
def test_json_compact_all_types(http_duck_with_token, token_client: Client):
    res = token_client.execute_query("FROM test_all_types()", response_format=ResponseFormat.COMPACT_JSON)
